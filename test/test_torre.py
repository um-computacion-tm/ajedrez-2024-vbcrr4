...
class TestTorre(unittest.TestCase):
    def setUp(self):
        ...
        self.__posicionocupada__ = Torre("White", (4, 3))
        self.__positions__[1][1] = self.__torre__
        self.__positions__[4][3] = self.__posicionocupada__

    def test_assign_value(self):
        self.assertEqual(self.__torre__.assign_value(), 5)

    def test_valid_white_move(self):
        self.assertTrue(self.__torre__.piece_move(self.__positions__,(3, 5)))
